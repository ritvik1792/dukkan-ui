    ...
    <div>
      ...
      <section className="mt-8">
        <div className="flex items-end justify-between gap-3">
          ...
          <Link href={adminConsolePath("/sellers")} className="text-sm underline">
            Manage dukkans
          </Link>
        </div>
              ...
              {stats.shops.map((row) => (
                ...
                >
                  <td className="px-4 py-3">
                    <ShopNameButton shopId={row.shop.id} className="font-medium underline decoration-stone-300 hover:decoration-ink">
                      {row.shop.name}
                    </ShopNameButton>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <section className="rounded-2xl bg-white p-5">
          <div className="flex items-end justify-between gap-3">
            ...
            <Link href={adminConsolePath("/applications")} className="text-sm underline">
              Open queue
            </Link>
          </div>
