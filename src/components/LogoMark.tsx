export function LogoMark({ className = "h-8 w-8" }: { className?: string }) {
  return (
    <svg
      ...
      role="img"
    >
      <title>Pink Carrot</title>
      {/* Vibrant rose-pink brand tile */}
      <rect width="32" height="32" rx="9" fill="#E11D48" />
      {/* Soft green carrot leaves */}
      <path
      ...
      <path
        ...
        fill="#8BAF7A"
      />
      {/* Cute rounded carrot body — champagne cream */}
      <path
      ...
      <path
        ...
        opacity="0.9"
      />
      {/* Friendly eyes — warm espresso */}
      <circle cx="15.2" cy="15.2" r="1.05" fill="#1E1418" />
      <circle cx="18.3" cy="14.6" r="1.05" fill="#1E1418" />
      <circle cx="15.45" cy="14.95" r="0.35" fill="#FAF6F0" />
      <circle cx="18.55" cy="14.35" r="0.35" fill="#FAF6F0" />
      {/* Smile */}
      <path
